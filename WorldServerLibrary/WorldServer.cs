...
namespace WorldServerLibrary
{
    public class WorldServer:IDisposable
    {
		...
		public string sendNewDeliverySpot(int type, double x, double y){
			String response = String.Empty;
		...
		public void sendHideIt(string creatureId, string thingName){
		...
		public void sendUnHideIt(string creatureId, string thingName){
                    ...
                    if (tokensProcessed != null && tokensProcessed.Length > 0)
                    {
						...
						if (creature.HasLeaflet) {
							...
							for (int i=0;i<creature.NumberOfLeaflets;i++) {
								...
								SetAttribute(l, "completed", enumerator);
            ...
            if (model != null && !String.IsNullOrWhiteSpace(propertyName) && enumerator != null && enumerator.MoveNext())
            {
                ...
                if (property != null)
                {
                    ...
                    else if (property.PropertyType == typeof(Boolean))
                    {
						...
						if (currentToken.Equals("false") || currentToken.Equals("true")) {
							Boolean value = Convert.ToBoolean (currentToken);
